        ...
        <asp:Panel runat="server" ID="PanelSolicitud">        
            ...
            <table style="align-content: center; width: 95%">
                ...
                <tr style="align-content: center">
                    ...
                    <td  colspan="2" style="width:40%">
                        <asp:Label ID="lblCodigo" runat="server" CssClass="text-primary" Font-Bold="True" ForeColor="#000066" Text="Codigo"></asp:Label>
                        <br />
                        <asp:Button ID="btnGenerarFolio" runat="server" OnClick="btnGenerarFolio_Click" Text="Mostrar Folio" />
                    </td>
                </tr>
                <tr style="align-content: center">
                ...
                <tr style="align-content: center">
                    <td  colspan="3" style="align-content: flex-start;">
                        ...
                        <asp:Label ID="Label31" runat="server" Font-Bold="True" Font-Names="Arial Black" Font-Size="15pt" ForeColor="Red" Text="*"></asp:Label>
                        <br />
                ...
                <tr>
                    <td  colspan="3" style="align-content: flex-start;">
                        ...
                        <asp:Label ID="Label32" runat="server" Font-Bold="True" Font-Names="Arial Black" Font-Size="15pt" ForeColor="Red" Text="*"></asp:Label>
                        <br />
                ...
                <tr>
                    <td  colspan="3" style="align-content: flex-start;">
                        ...
                        <asp:Label ID="Label33" runat="server" Font-Bold="True" Font-Names="Arial Black" Font-Size="15pt" ForeColor="Red" Text="*"></asp:Label>
                        <br />
                ...
                <tr>
                    <td colspan="3" style="align-content:flex-start">
                        ...
                        <asp:Label ID="Label34" runat="server" Font-Bold="True" Font-Names="Arial Black" Font-Size="15pt" ForeColor="Red" Text="*"></asp:Label>
                        <br />
                ...
                <tr style="align-content: center">
                    <td colspan="3" style="align-content:center;text-align: center; height: 71px;" >
                        <br />
                ...
                <tr>
                    <td style="align-items: center; width: auto" colspan="3">
                        <asp:Panel ID="panelEntregable" runat="server" Height="129px" Visible="False" Style="text-align: center" Width="100%">
                            ...
                            <br />
                            <br />
                            <asp:Button ID="btnGuardarEntregable" runat="server" OnClick="btnGuardarEntregable_Click" Text="Guardar" Width="170px" />
                            &nbsp;<asp:Button ID="btnMostarPanelActividad" runat="server" OnClick="btnMostarPanelActividad_Click" Text="Agregar Actividad" />
                            &nbsp;&nbsp;&nbsp;
                                        <asp:Button ID="btnNvoEntregable" runat="server" OnClick="btnNvoEntregable_Click" Text="Nuevo" />
                            <br />
                        </asp:Panel>
                    </td>
                            ...
                            <asp:GridView ID="gvTablaDatos" runat="server" AutoGenerateColumns="False" ShowFooter="True"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField>
                                        ...
                                        <FooterTemplate>
                                            <asp:ImageButton ImageUrl="~/Imagenes/addnew.png" runat="server" CommandName="AddNew" ToolTip="Agregar nuevo" Width="35px" Height="35px" />
                                        </FooterTemplate>
                                    </asp:TemplateField>
                                </Columns>
                            </asp:GridView>
                ...
                <tr style="align-content: center">
                    <td colspan="3"  style="align-content: center; text-align: center;">
                        <br />
                        <asp:Label ID="Label12" runat="server" Text="Agregar Grupo de Trabajo" CssClass="text-primary" Font-Bold="True" Font-Size="12pt"></asp:Label>
                        <br />
                        <asp:ImageButton ID="btnAgregarIntegrantes" runat="server" Height="50px" ImageUrl="~/Imagenes/agregar_Integrantes.png" Width="50px" OnClick="btnAgregarIntegrantes_Click" />
                ...
                <tr>
                    <td>&nbsp;</td>
                    <td>&nbsp;</td>
                    <td colspan="2" style="text-align: left">&nbsp;<asp:Button ID="btnGuardarProyecto" runat="server" Text="Guardar" OnClick="btnGuardarProyecto_Click" CssClass="btn btn-primary" />
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
