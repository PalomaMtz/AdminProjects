...
namespace AdminProjects.FormulariosWeb
{
    public partial class AltaProyecto : System.Web.UI.Page
    {
        ...
        protected void btnMostrarInformacion_Click(object sender, EventArgs e)
        {
            ...
            {
                string msg = "Seleccione una empresa y el nombre del proyecto";
            ...
            {
                this.FolioProyecto = this.Procedimiento.ConsultaIDProyecto(this.ddlProyectos.SelectedValue);
                ...
                {//DescripciónPropuesta,ObjetivoProyecto,ResultadosEsperados
                    ...
                    this.txtDescripcion.Text = fila["DescripciónPropuesta"].ToString();
                    fila = TablaProyectos.Rows[0];
        ...
        {
            DataTable ds = this.Procedimiento.EmpresasActivas();
            this.ddlEmpresas.DataSource = ds;
